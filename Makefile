...
reports/%.md: wp/Human/%.ttl wp/gpml/Human/%.ttl src/java/main/org/wikipathways/covid/CheckRDF.class
	...
	@mkdir -p reports
	@java -cp libs/jena-arq-4.6.1.jar:src/java/main/:libs/slf4j-simple-1.7.32.jar:libs/wikipathways.curator-1-SNAPSHOT-jar-with-dependencies.jar org.wikipathways.covid.CheckRDF $< $@
